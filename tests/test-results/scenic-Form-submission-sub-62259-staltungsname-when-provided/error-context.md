...
- Name: scenic.spec.js >> Form submission >> submitted payload includes Veranstaltungsname when provided
- Location: scenic.spec.js:451:7
          ...
          - generic [ref=e46]:
            ...
            - generic [ref=e50]:
              - generic [ref=e51]:
                ...
                - generic [ref=e52]: "?"
                - text: "*"
              - spinbutton "Personenzahl ? *" [active] [ref=e53]: "1000"
        - text: "* * * * * * * * * * * * * * * * *  "
      - generic [ref=e54]:
