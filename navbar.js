(function () {
    ...
    const inSites = window.location.pathname.replace(/\\/g, '/').includes('/sites/');
    const root = inSites ? '../' : '';
    ...
    const links = [
        ...
        {id: 'background.html', href: sites + 'background.html', label: 'Hintergrund'},
        {id: 'procedure_description.html', href: sites + 'procedure_description.html', label: 'Verfahren'},
    ];
